              ...
              <Popover.Button
                className={`${
                  open
                    ...
                    : 'bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 hover:text-current dark:hover:bg-gray-700'
                } active:bg-gray-500 active:text-white dark:active:bg-gray-800 group px-4 py-2 rounded-md shadow-sm focus-ring-outline`}
              >
                {children}
              </Popover.Button>
              <Transition
